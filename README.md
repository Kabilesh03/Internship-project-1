...
i)	Problem Statement:
	...
	II) Data Science Task:
		...
		i) Class Imbalance:
				Encountered class imbalance among the iris species, especially if one 			species had significantly fewer instances. Mitigated this issue by using techniques 			like Synthetic Minority Over-sampling Technique (SMOTE) to balance the classes.
